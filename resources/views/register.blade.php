      ...
      <div class="card-body">
        <form method="POST" action="{{ route('register-action') }}">
          ...
          <div class="form-group">
            ...
            <input name="username" class="form-control" id="register-username" type="text" placeholder="Enter username">
          </div>
          <div class="form-group">
            <div class="form-row">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                ...
                <input name="confirm-password" class="form-control" id="exampleConfirmPassword" type="password" placeholder="Confirm password">
              </div>
            </div>
          </div>
